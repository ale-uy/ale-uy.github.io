...
window.addEventListener('keydown', (event) => {
  switch(event.key.toLowerCase()) {
    case '0': // 0 to pause/resume
      event.preventDefault();
      const pauseBtn = document.getElementById('pauseBtn');
      if (pauseBtn) pauseBtn.click();
      break;
    case '1': // 1 to reset view
      const resetBtn = document.getElementById('resetBtn');
      if (resetBtn) resetBtn.click();
      break;
    case '2': // 2 to stop following planet
      stopFollowingPlanet();
      break;
    case '3': // 3 to toggle orbits
      const orbitsBtn = document.getElementById('orbitsBtn');
      if (orbitsBtn) orbitsBtn.click();
      break;
    case '4': // 4 to cycle through asteroid belt types
      ...
      break;
    case '5': // 5 to toggle moons
      const moonsBtn = document.getElementById('moonsBtn');
      if (moonsBtn) moonsBtn.click();
      break;
    case '6': // 6 to toggle UI visibility
      const hideUIBtn = document.getElementById('hideUIBtn');
      const showUIBtn = document.getElementById('showUIBtn');
      ...
      break;
    case '7': // 7 to toggle music (Play/Pause)
      const musicBtn = document.getElementById('musicBtn');
      const muteMusicBtn = document.getElementById('muteMusicBtn');
    ...
    case '-': // Decrease speed
      ...
      break;
    case '8': // 8 to toggle bloom mode (Auto/Manual)
      event.preventDefault();
      isBloomManual = !isBloomManual;
      const bloomModeBtn = document.getElementById('bloomModeBtn');
      if (bloomModeBtn) {
